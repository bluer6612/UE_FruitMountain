...
public:
    static const FString DEFAULT_KOREAN_FONT_PATH;
    static const FString DEFAULT_NUMBER_FONT_PATH;
    
    // 텍스트 블록 스타일 설정 헬퍼 함수
    UFUNCTION(BlueprintCallable, Category = "UI Helper")
    static void SetupTextBlockStyle(UTextBlock* TextBlock, FLinearColor Color, float FontSize, const FString& FontPath, bool bBold = false, bool bAutoWrapText = true, ESlateVisibility DefaultVisibility = ESlateVisibility::HitTestInvisible);
