...
const FVector2D UScoreDisplayWidget::COMBO_TEXT_POS = FVector2D(710.0f, 90.0f);
const FLinearColor UScoreDisplayWidget::SCORE_YELLOW_COLOR = FLinearColor(1.0f, 0.98f, 0.5f, 1.0f);
