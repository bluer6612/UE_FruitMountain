...
APlateActor::APlateActor()
{
    ...
    static ConstructorHelpers::FObjectFinder<UStaticMesh> CylinderAsset(TEXT("/Game/Asset/Mesh_Bowl"));
    if (!CylinderAsset.Succeeded())
    {
        UE_LOG(LogTemp, Warning, TEXT("CylinderAsset not found!"));
        return;
    }
    ...
    PlateMesh->SetStaticMesh(CylinderAsset.Object);
